...
_mfk_mod.END = "20260604"
_pyr_mod.END = "20260604"
_v7_mod.END  = "20260604"
_am_mod.END  = "20260604"
...
def update_per_stock(daily_by_code):
    ...
    def write(parts, out_dir, name):
        ...
        out_dir.joinpath(f"{name}_ext_0605.parquet").parent.mkdir(exist_ok=True)
        out = out_dir / f"{name}_ext_0605.parquet"
