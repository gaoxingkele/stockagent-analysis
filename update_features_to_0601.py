...
_mfk_mod.END = "20260601"
_pyr_mod.END = "20260601"
_v7_mod.END  = "20260601"
_am_mod.END  = "20260601"
...
def update_per_stock(daily_by_code):
    ...
    def write(parts, out_dir, name):
        ...
        out_dir.joinpath(f"{name}_ext_0601.parquet").parent.mkdir(exist_ok=True)
        out = out_dir / f"{name}_ext_0601.parquet"
