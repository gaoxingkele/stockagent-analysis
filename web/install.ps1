...
Write-Host "  2. 启动应用: .\venv\Scripts\python.exe -m uvicorn app.main:app --host 0.0.0.0 --port 8000"
Write-Host "  3. ngrok 映射: ngrok http 8000"
Write-Host "  4. 访问: http://localhost:8000/login"
